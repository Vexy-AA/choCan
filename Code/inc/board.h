...
#define LINE_LED13                   PAL_LINE(GPIOC, 1U)
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_OTG_FS_POWER_ON) |\
                                     PIN_OTYPE_PUSHPULL(GPIOC_LED13) |       \
